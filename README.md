...
2. [Jupyter Notebooks](#jupyter-notebooks)
   ...
   - [Assessing phase triplet misclosure using ariaMisclosure.py - ariaMisclosure.py program tutorial](https://nbviewer.jupyter.org/github/aria-tools/ARIA-tools-docs/blob/master/JupyterDocs/ariaMisclosure/ariaMisclosure_tutorial.ipynb)
